					...
					<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="<?php echo base_url('assets/images/product-details/similar1.jpg')?>" alt=""></a>
										  <a href=""><img src="<?php echo base_url('assets/images/product-details/similar2.jpg')?>" alt=""></a>
										  <a href=""><img src="<?php echo base_url('assets/images/product-details/similar3.jpg')?>" alt=""></a>
										</div>
										<div class="item">
										  <a href=""><img src="<?php echo base_url('assets/images/product-details/similar1.jpg')?>" alt=""></a>
										  <a href=""><img src="<?php echo base_url('assets/images/product-details/similar2.jpg')?>" alt=""></a>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>Anne Klein Sleeveless Color Black</h2>
								<p>Web ID: 1089772</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										<li><a href=""><i class="fa fa-user"></i>PANJI</a></li>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by Panji Ramadanu<span><a target="_blank" href="#"></a></span></p>
				</div>
			</div>
		</div>
