						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<p>FREE SHIPPING || Gratis biaya kirim untuk semua pemesanan diatas 250rb. </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-SHOPPER</h1>
									<p>GARANSI UANG KEMBALI || Tidak puas? Langsung kami ganti atau refund. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-SHOPPER</h1>
									<p>BAYAR DITEMPAT (COD) || Dijamin aman dan mudah. Bayar saat barang diterima.</p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
					...
					<div class="left-sidebar">
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 ...
								 <b class="pull-left">Rp. 1.000</b> <b class="pull-right">Rp. 1.000.000</b>
							</div>
						</div><!--/price-range-->
