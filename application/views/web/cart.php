				...
				<table class="table table-condensed">
					...
					<tbody>
						<tr>
							...
							<td class="cart_total">
								<p class="cart_total_price">Rp. 70.000</p>
							</td>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span>Rp. 70.000</span></li>
							<li>Voucher<span>Rp. 5.000</span></li>
							<li>Shipping Cost <span>Free</span></li>
							<li>Total <span>Rp. 255.000</span></li>
						</ul>
